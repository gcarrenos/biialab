        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-center lg:max-w-md">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full rounded-full bg-surface border border-gray-700/50 py-2 pl-9 pr-4 text-sm text-text-primary placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-accent"
            />
          </div>
        </div>
